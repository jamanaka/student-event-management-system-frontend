          ...
          >
            ...
            <div style={{
              ...
              <span style={{
                ...
                transform: isMobileMenuOpen ? 'rotate(45deg) translateY(-50%)' : 'none',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button 
              ...
              onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(74, 105, 189, 0.1)'}
              ...
              <>
                ...
                <Link 
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 4px 15px rgba(74, 105, 189, 0.4)';
                  }}
                  onMouseLeave={(e) => {
